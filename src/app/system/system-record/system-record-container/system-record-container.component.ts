...
@Component({
  selector: 'hw-system-record-container',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './system-record-container.component.html',
  styleUrl: './system-record-container.component.less',
  providers: [SystemRecordSource],
})
export class SystemRecordContainerComponent {
