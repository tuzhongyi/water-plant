...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   <span class='select2-chosen'>&ensp;</span><abbr class='select2-search-choice-close'></abbr>",
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        addSelectedChoice: function (data) {
            ...
            //choice.find(".select2-search-choice-focus").removeClass("select2-search-choice-focus");
            //val[0] = id;
