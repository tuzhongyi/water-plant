function scscms_alert(msg,sign,ok,can){
	...
	if (sign=="confirm"){
	    s += "<a class='btn btn-primary' href='javascript:void(0)' id='confirm_ok'>确 定</a><a   class='btn btn-default' href='javascript:void(0)' id='confirm_cancel'>取 消</a>";
	}else{
	    s += "<a class='btn btn-primary' href='javascript:void(0)' id='alert_ok'>确 定</a>"
	}
