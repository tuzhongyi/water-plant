...
(function($) {
    ...
    Progressbar.prototype.transition = function (options) {
        if (options)
            this.options = $.extend({}, Progressbar.defaults, options);
        ...
        if (options.display_text !== 'none' && options.display_text !== 'fill' && !$back_text && !$front_text) {
            ...
            var progress = setInterval(function() {
                ...
                if (options.display_text !== 'none') {
                    ...
                    if (options.display_text === 'fill') {
                        ...
                        $back_text.text(options.display_text);
                        $front_text.text(options.display_text);
                    }
                }
